# %% [markdown]
# First derivative, 3-layer CNN, relu activation, first stage, NMSE, spectral bias experiments
...
# %%
def NMSELoss(predicted, observed):
     MSE = nn.MSELoss()(predicted, observed)
     NMSE = MSE / torch.mean(observed ** 2)
     return NMSE
...
torch.save(model2.state_dict(), 'models/E200_D1_3L_AFrelu_NMSE_SB.pth')
plot_losses(train_losses=train_losses, test_losses=test_losses, save_dir='plots/spectral_bias', filename='E200_D1_3L_AFrelu_NMSE_loss', save=save)
plot_output(model2, order=1, save_dir='plots/spectral_bias', filename='E200_D1_3L_AFrelu_NMSE_output', save=save)
...
torch.save(model2.state_dict(), 'models/E600_D1_3L_AFrelu_NMSE_SB.pth')
plot_losses(train_losses=train_losses, test_losses=test_losses, save_dir='plots/spectral_bias', filename='E600_D1_3L_AFrelu_NMSE_loss', save=save)
plot_output(model2, order=1, save_dir='plots/spectral_bias', filename='E600_D1_3L_AFrelu_NMSE_output', save=save)
...
# %%
train_losses, test_losses = model_training(model2, 400, order='first')
torch.save(model2.state_dict(), 'models/E1000_D1_3L_AFrelu_NMSE_SB.pth')
plot_losses(train_losses=train_losses, test_losses=test_losses, save_dir='plots/spectral_bias', filename='E1000_D1_3L_AFrelu_NMSE_loss', save=save)
plot_output(model2, order=1, save_dir='plots/spectral_bias', filename='E1000_D1_3L_AFrelu_NMSE_output', save=save)
