...
torch.save(model1.state_dict(), 'models/E1000_D1_AFnone.pth')
...
# %%
plot_losses(train_losses=train_losses, test_losses=test_losses, filename='D1_1L_AFnone_loss', save=True)
...
# %%
plot_output(model1, order=1, save_dir='plots', filename='D1_1L_AFnone_output', save=True)
