...
model_training(4000, order='first')
torch.save(model1.state_dict(), 'models/E10000_D1_3L_AFrelu_1S.pth')
...
# %%
plot_losses(train_losses=train_losses, test_losses=test_losses, filename='D1_3L_AFrelu_1S_E10000_loss', save=True)
...
# %%
plot_output(model1, order=1, save_dir='plots', filename='D1_3L_AFrelu_1S_E10000_output', save=save)
