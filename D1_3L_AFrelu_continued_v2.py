...
train_losses, test_losses = model_training(model1, 1000, lr_factor=epsilon, save_opt=False, order=1)
# This model will be the result of continued training of the first stage
torch.save(model1.state_dict(), 'models/E1000_D1_3L_AFrelu_1S_continued.pth')
...
# %%
plot_losses(train_losses=train_losses, test_losses=test_losses,\
    save_dir='plots/continued', filename='D1_3L_AFrelu_1S_continued_loss', save=save)
